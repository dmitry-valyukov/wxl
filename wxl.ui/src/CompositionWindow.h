...
//
// Окно -- хендл общего состояния, как всякая обёртка wxl: копия смотрит в то
...
//     };
//
// Само окно Windows держит своё состояние до WM_NCDESTROY: отпущенный последний
// хендл не освобождает его под живым окном.
//
