...
struct Closure {
    ...
    // declares them.
    std::map<winmd::reader::TypeDef, std::set<std::string>> members;
    ...
    std::map<winmd::reader::TypeDef, std::vector<winmd::reader::TypeDef>> dropped_interfaces;
    ...
    // Object.
    std::set<winmd::reader::TypeDef> listed_interfaces;
    ...
    std::map<winmd::reader::TypeDef, std::vector<winmd::reader::TypeDef>> factories;
    ...
    std::map<winmd::reader::TypeDef, std::vector<winmd::reader::TypeDef>> statics;
    ...
    std::map<winmd::reader::TypeDef, std::vector<std::string>> attached;
